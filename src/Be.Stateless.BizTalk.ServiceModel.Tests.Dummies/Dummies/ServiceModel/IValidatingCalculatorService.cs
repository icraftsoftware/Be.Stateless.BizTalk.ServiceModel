...
{
	[ServiceContract(Namespace = "urn:services.stateless.be:unit:calculator", Name = "validating-calculator")]
	[XmlSerializerFormat]
	public interface IValidatingCalculatorService
	{
		[OperationContract]
		[return: MessageParameter(Name = "CalculatorResponse")]
		XLangCalculatorResponse Add(
