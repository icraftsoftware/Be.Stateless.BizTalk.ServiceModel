...
{
	[ServiceContract(Namespace = "urn:services.stateless.be:unit:calculator", Name = "translating-calculator")]
	[XmlSerializerFormat]
	public interface ITranslatingCalculatorService
	{
		[OperationContract]
		[return: MessageParameter(Name = "CalculatorResponse")]
		XLangCalculatorResponse Subtract(
		...
		[return: MessageParameter(Name = "CalculatorResponse")]
		XLangCalculatorResponse EndDivide(IAsyncResult asyncResult);
	}
}
