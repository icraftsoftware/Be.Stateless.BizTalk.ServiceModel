...
{
	/// <summary>
	/// Provides a basic service proxy client implementation that can call the <see cref="IStubService"/> endpoint to perform
	/// solicit-response-only message exchanges.
	/// </summary>
	...
	/// <summary>
	/// Provides a basic service proxy client implementation that can call the <see cref="IStubService"/> endpoint to exchange
	/// messages through the <typeparamref name="TChannel"/>-shaped channel.
	/// </summary>
