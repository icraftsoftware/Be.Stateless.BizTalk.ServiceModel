...
namespace Be.Stateless.BizTalk.Xml.Schema
{
	/// <summary>
	/// Scaffolding interface meant to help an <see cref="XmlMessage{TSchemaProvider}"/>-derived class to either get the <see
	/// cref="XmlSchema"/> against which to validate its XML representation, or fulfill its contract with respect to the <see
	/// cref="XmlSchemaProviderAttribute"/>.
	/// </summary>
	/// <remarks>
	/// Provides the <see cref="XmlSchema"/> to the <see cref="XmlSchemaSet"/> and the <see cref="XmlSchemaType"/> that controls
