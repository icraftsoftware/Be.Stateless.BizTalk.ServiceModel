...
namespace Be.Stateless.BizTalk.Xml.Xsl
{
	...
	public abstract class XsltTransformBase
	{
		...
		{
			Xslt = LoadXslCompiledTransform();
		}

		/// <summary>
		/// The <see cref="XslCompiledTransform"/> whose content has been loaded from the <see cref="XsltTransformBase"/>-derived
		/// type's assembly resources.
		/// </summary>
		public XslCompiledTransform Xslt { get; }
