...
namespace Be.Stateless.BizTalk.ServiceModel.Channels
{
	...
	/// content is defined by an <see cref="XmlSchema"/> that a <typeparamref name="TSchemaProvider"/> can provide.
	/// </summary>
	/// <remarks>
	...
	{
		/// <summary>
		/// Scaffolding method that helps a derived class to fulfill its <see cref="XmlSchemaProviderAttribute"/>'s contract in
		/// providing the <see cref="XmlSchema"/> to the <paramref name="schemaSet"/> and the <see cref="XmlSchemaType"/> that
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XmlMessage{TSchemaProvider}"/> class that will skip XML validation.
		/// </summary>
