...
{
	/// <summary>
	/// Scaffolding interface meant to help the service relay, together made of the <see cref="ServiceRelay"/> and its necessary
	/// <see cref="ClientRelay"/> counterpart, to convert <see cref="XmlMessage"/>s back and forth to native generic WCF <see
	/// cref="Message"/>s.
	/// </summary>
