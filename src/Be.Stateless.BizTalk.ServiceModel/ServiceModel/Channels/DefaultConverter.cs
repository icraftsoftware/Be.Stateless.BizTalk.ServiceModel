...
namespace Be.Stateless.BizTalk.ServiceModel.Channels
{
	...
	public class DefaultConverter : IXmlMessageConverter
	{
		...
		/// Singleton instance
		/// </summary>
		public static IXmlMessageConverter Instance { get; } = new DefaultConverter();
			...
			where TRequest : XmlMessage
		{
			...
			return System.ServiceModel.Channels.Message.CreateMessage(xmlRequest.Version, xmlRequest.Action, xmlRequest.GetReaderAtContent());
		}
