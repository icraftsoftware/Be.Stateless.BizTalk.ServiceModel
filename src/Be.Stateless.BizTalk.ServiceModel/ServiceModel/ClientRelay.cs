...
namespace Be.Stateless.BizTalk.ServiceModel
{
	...
	/// </summary>
	/// <seealso href="https://docs.microsoft.com/en-us/dotnet/framework/wcf/feature-details/using-the-message-class" />
	/// <seealso href="http://twenty6-jc.blogspot.com/2010/07/wcf-client-performance-improvement.html" />
	/// <seealso href="https://chainding.wordpress.com/2010/06/29/performance-improvement-for-wcf-client-proxy-creation-in-net-3-5-and-best-practices/" />
	internal class ClientRelay : ClientBase<IRequestChannel>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ClientRelay"/> class using the configuration information specified in
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ClientRelay"/> class using the specified <paramref name="binding"/> and
		...
		public EndpointAddress RemoteAddress => Channel.RemoteAddress;

		/// <summary>
		/// Sends an <see cref="XmlMessage"/>-based request and returns the correlated <see cref="XmlMessage"/>-based response.
		/// </summary>
		...
		/// </para>
		/// </remarks>
		/// <see cref="IRequestChannel.Request(System.ServiceModel.Channels.Message,TimeSpan)"/>
		[SuppressMessage("ReSharper", "UnusedMember.Global", Justification = "Public API.")]
		...
		public TResponse Request<TRequest, TResponse>(TRequest xmlRequest, TimeSpan timeout, IXmlMessageConverter converter)
			...
			where TResponse : XmlMessage, new()
		{
			if (xmlRequest == null) throw new ArgumentNullException(nameof(xmlRequest));
		...
		/// <summary>
		/// Begins an asynchronous operation to convert and transmit an <see cref="XmlMessage"/>-based request to the reply side
		...
		/// </para>
		/// </remarks>
		/// <seealso cref="IRequestChannel.BeginRequest(System.ServiceModel.Channels.Message,TimeSpan,AsyncCallback,object)"/>
		[SuppressMessage("ReSharper", "MemberCanBePrivate.Global", Justification = "Public API.")]
		...
		/// transmitted <see cref="XmlMessage"/>-based request.
		/// </summary>
		/// <typeparam name="TResponse">
		/// The type of the <see cref="XmlMessage"/>-based response.
		/// </typeparam>
			...
			where TResponse : XmlMessage, new()
		{
			...
			var request = (System.ServiceModel.Channels.Message) tuple[0];
			request.Close();
