...
namespace Be.Stateless.BizTalk
{
	...
	/// </summary>
	/// <remarks>
	/// See <see cref="ServiceRelay.BeginRelayRequest{TRequest}(TRequest,System.AsyncCallback,object)"/> for sample usages.
	/// </remarks>
	...
	public class AsyncResultWrapper : IAsyncResult
	{
		...
		/// </returns>
		public bool IsCompleted => WrappedAsyncResult.IsCompleted;
		...
		/// </returns>
		public WaitHandle AsyncWaitHandle => WrappedAsyncResult.AsyncWaitHandle;

		/// <summary>
		/// Gets a user-defined <see cref="object"/> that qualifies or contains information about an asynchronous operation.
		/// </summary>
		/// <returns>
		/// A user-defined <see cref="object"/> that qualifies or contains information about an asynchronous operation.
		/// </returns>
		...
		/// </returns>
		public bool CompletedSynchronously => WrappedAsyncResult.CompletedSynchronously;
		...
		/// </summary>
		public IAsyncResult WrappedAsyncResult { get; }
	}
}
