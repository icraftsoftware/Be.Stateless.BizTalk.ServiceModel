...
{
	[ServiceContract(Namespace = "urn:services.stateless.be:unit:calculator", Name = "calculator")]
	[XmlSerializerFormat]
	public interface ICalculatorService
	{
		[OperationContract]
		[return: MessageParameter(Name = "CalculatorResponse")]
		XmlCalculatorResponse Add(
			[MessageParameter(Name = "CalculatorRequest")]
			XmlCalculatorRequest request);

		[OperationContract]
		[return: MessageParameter(Name = "CalculatorResponse")]
		XmlCalculatorResponse Subtract(
			[MessageParameter(Name = "CalculatorRequest")]
			XmlCalculatorRequest request);
