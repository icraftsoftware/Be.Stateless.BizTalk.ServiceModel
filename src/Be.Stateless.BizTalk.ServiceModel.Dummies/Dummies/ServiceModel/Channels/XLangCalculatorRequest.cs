...
namespace Be.Stateless.BizTalk.Dummies.ServiceModel.Channels
{
	...
	public class XLangCalculatorRequest : XLangMessage<CalculatorSchema.Request>
	{
		...
		private XLangCalculatorRequest() : base(XmlSchemaContentProcessing.Strict) { }

		/// <summary>
		/// Bootstraps RawXmlBody during unit testing
		/// </summary>
		internal XLangCalculatorRequest(string rawXmlBody) : this()
		{
